...
$.extend($.validator, {
	...
	messages: {
		required: "ضروری",
		remote: "لطفا با دقت وارد کنید.",
		email: "ایمیل نامعتبر",
		url: "لطفا ادرس اینترنتی صحیح وارد کنید.",
		date: "لطفا تاریخ درست وارد کنید.",
		dateISO: "لطفا یک تاریخ وارد کنید.",
		number: "لطفا یک شماره را وارد کنید.",
		digits: "فقط یک را انتخاب کنید.",
		creditcard: "لطفا شماره کارت را وارد کنید.",
		equalTo: "لطفا دوباره تکرار کنید.",
