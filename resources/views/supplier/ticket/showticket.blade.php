        ...
        <div class="chat_content">
            <div id="chat_content" style="padding: 2em;height: 550px;position: relative;">
                @foreach($tickets as $ticket)
                    <?php $user = \App\User::find($ticket->sender_id) ?>
                    ...
                    <span class="direct-chat-name float-left">
                        ...
                        {{ verta($ticket->created_at)->formatDifference() }}
                                ...
                                <!-- /.direct-chat-info -->
                                <img class="direct-chat-img" src="{{ url('images/'.$user->image) }}" alt="message user image">
                                <!-- /.direct-chat-img -->
            ...
            <div class="input-group"  style="width: 100%">
                ...
                <span class="input-group-append">
                    <button onclick="send_message()" type="button" class="btn btn-info btn-flat" style="border-radius: 0 0 0 0.25rem">ارسال</button>
                  </span>
            </div>
        </div>
