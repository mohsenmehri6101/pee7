...
@section('page_header')
    <li class="breadcrumb-item"><a class="text-info" href="{{ route('admin.setting.login.index') }}">صفحه ورود</a></li>
...
<section class="content">
    <div class="row float-left">
        <a href="{{route('admin.setting.login.edit') }}" class="btn bg-warning-gradient border ">
             ویرایش
        </a>
    </div>
    <br>
    ...
    <div class="row">
        ...
        @if($setting->list['link'])
            <div class="row">
                <div class="col">
                    <a target="_blank" href="{{$setting->list['link']}}" class="float-left btn btn-primary">
                        بیشتر
                    </a>
