...
@section('page_header')
    <li class="breadcrumb-item"><a class="text-info" href="{{ route('admin.setting.login.edit') }}">
            ویرایش صفحه ورود
        </a></li>
    <li class="breadcrumb-item"><a class="text-secondary" href="{{ route('admin.setting.login.index') }}">تنظیم صفحه ورود</a></li>
...
@section('content')
    <div class="row">
        ...
        <div class="col-md-9">
            <form action="{{ route('admin.setting.login.update' , ['id' => $setting->id]) }}" method="post" enctype="multipart/form-data" >
                {{ csrf_field() }}
