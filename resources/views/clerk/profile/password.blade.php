...
@section('page_header')
    <li class="breadcrumb-item"><a class="text-info" href="{{ route('clerk.profile.password') }}">تغییر رمز ورود</a></li>
                ...
                <div class="card-footer p-0">
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-xs-8 text-center">
                                <form class="p-2 my-2 bg-light" action="{{ route('clerk.profile.password' , ['id' => $user->id]) }}" method="post" >
                                    {{ csrf_field() }}
