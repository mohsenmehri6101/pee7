...
@section('page_header')
    <li class="breadcrumb-item"><a href="{{ route('company.profile.edit') }}">ویرایش اطلاعات</a></li>
        ...
        <form action="{{ route('company.profile.update' , ['id' => $user->id]) }}" method="post" enctype="multipart/form-data" >
            ...
            <div class="card card-primary card-outline">
                <div class="card-header">
                    <h3 class="card-title">ویرایش اطلاعات<a href="{{ route('company.profile.index') }}"> {{ $user->name }}</a></h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <input class="form-control" name="id_company" value="{{ $user->company->id_company }}" placeholder="شناسه شرکت">
                    </div>
                    <div class="form-group">
                        <input class="form-control" name="id_recording" value="{{ $user->company->id_recording }}" placeholder="شماره ثبت">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <textarea name="about" id="" class="form-control textarea" rows="5" placeholder="توضیحات بیشتر(اختیاری...)">{{ $user->company->about }}</textarea>
                    </div>
                    <div class="form-group">
                        @if($user->image)
