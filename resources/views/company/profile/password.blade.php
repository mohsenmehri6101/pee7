...
@section('page_header')
    <li class="breadcrumb-item"><a class="text-info" href="{{ route('company.profile.password') }}">تغییر رمز ورود</a></li>
                    ...
                    @if(auth()->user()->company)
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-xs-8 text-center">
                                <form class="p-2 my-2 bg-light" action="{{ route('company.profile.password' , ['id' => $user->id]) }}" method="post" >
                                    {{ csrf_field() }}
