...
@section('page_header')
    <li class="breadcrumb-item"><a class="text-info" href="{{ route('person.profile.index') }}">پروفایل</a></li>
@endsection
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card card-widget widget-user-2">
                ...
                @include('person.layouts.widget_user_header')
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="description-block text-right pr-3">
                                    ...
                                    <p>
                                        <i class="fa fa-info pl-2"></i>
                                        <span class="text-secondary">شماره ملی :</span>
                                        {{ auth()->user()->person->self_id }}
                                    </p>
                                </div>
                                <!-- /.description-block -->
                            </div>
