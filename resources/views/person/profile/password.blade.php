...
@section('page_header')
    <li class="breadcrumb-item"><a class="text-info" href="{{ route('user.profile.password') }}">تغییر رمز عبور</a></li>
                    ...
                    @if(auth()->user()->person)
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-xs-8 text-center">
                                <form class="p-2 my-2 bg-light" action="{{ route('user.profile.password' , ['id' => $user->id]) }}" method="post" >
                                    {{ csrf_field() }}
